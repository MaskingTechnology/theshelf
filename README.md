...
Configurable TypeScript packages for common concerns that can be used "off the shelf".

All packages provide a generic interface that supports multiple implementations.
Implementations are configured via environment variables.
...
* [**Validation**](./packages/validation/README.md) - data validation.
